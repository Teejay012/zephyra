...
// import { DeployZephyraNFT } from "script/NFT/DeployZephyraNFT.s.sol";
...
//     function testPlayerLengthIncreasesIfEntered() public {
//         vm.warp(block.timestamp + 1 days);
...
//         assertGt(zephy.getAllPlayers().length, 0);
//     }

//     function testDuplicateUsersRevert() public {
//         vm.warp(block.timestamp + 1 days);

//         vm.startPrank(PLAYER);
//         zephy.tryLuck{value: raffleEntranceFee}();
//         vm.expectRevert(ZephyraNFT.ZephyraNFT__PlayerCantEnterMoreThanOnce.selector);
//         zephy.tryLuck{value: raffleEntranceFee}();
//         vm.stopPrank();
//     }
